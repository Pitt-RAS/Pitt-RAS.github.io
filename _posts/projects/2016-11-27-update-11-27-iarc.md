...
Initially, the idea of 3D printed landing gear made of a flexible filament was examined. In order to determine the spring constant of the material, an experiment was devised to find the spring constant of rectangular beams printed with material. Simulations were then run with the material properties using a 4kg load dropped from 2 meters. The results are covered in [this]() blog post.
